...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@hyperspaceng/neural-tui";
...
const THEME_KEY = Symbol.for("@hyperspaceng/neural-coding-agent:theme");
...
export function getSettingsListTheme(): import("@hyperspaceng/neural-tui").SettingsListTheme {
	return {
