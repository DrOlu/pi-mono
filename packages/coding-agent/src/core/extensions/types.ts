...
import type {
	...
	ThinkingLevel,
} from "@hyperspaceng/neural-agent-core";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@hyperspaceng/neural-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@hyperspaceng/neural-coding-agent";
	 *
