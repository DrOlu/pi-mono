...
import { Agent, type AgentMessage, type ThinkingLevel } from "@hyperspaceng/neural-agent-core";
import type { Message, Model } from "@hyperspaceng/neural-ai";
 ...
 *
 * // With explicit model
 * import { getModel } from '@hyperspaceng/neural-ai';
 * const { session } = await createAgentSession({
